  ...
  <tbody>
    <tr>
      ...
      <?php 
		  ...
		  if($tittle!='' and $meta_d!='' and $meta_k!='' and $date!='' and  $discription!='' and  $text!='' and $author!='')
			  
		  {
			  $pr=mysqli_query($db,"UPDATE videos SET tittle='$tittle', meta_d='$meta_d', meta_k='$meta_k', date='$date', discription='$discription',  author='$author', text='$text' WHERE id='$id'");
			  
			  if($pr==1)
			 
			 {
				  echo "Видео обновлено";
			  }
			  else
			  {
