...
$result=mysqli_query($db,"SELECT id, tittle FROM videos");?>
<!doctype html>
<html>
<head>
<meta charset="utf-8">
    ...
    <tr>
     ...
     <?php 
		  if(!isset($_GET['id']))
		  {
			  ...
			  {
				  printf("<p><a href=edit_video.php?id=%s>%s</a></p>",$myrow['id'],$myrow['tittle']);
			  }
...
print<<<HERE
<form name="form1" action="update_video.php" method="POST">
      		Заголовок <br>
      		...
      		Краткое описание <br>
			<textarea cols="40" type="text" name="discription" id="descriptions">$myrow[discription]</textarea><br>
      		Автор <br>
      		<input value="$myrow[author]" type="text" name="author" id="author"><br>
			Текст новости <br>
      		<textarea cols="40" type="text" name="text" id="text">$myrow[text]</textarea><br><input name="id" type="hidden" value="$myrow[id]">
